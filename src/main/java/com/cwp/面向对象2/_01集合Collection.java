...
public class _01集合Collection {
	...
	public void testCollection3() {
		...
		//12.hashCode():
		System.out.println(coll.hashCode());//-1454177893(哈希值)
		System.out.println();

		//13.toArray() :将集合转化为数组
		Object[] obj = coll.toArray();
		for(int i = 0;i < obj.length;i++){
			System.out.println(obj[i] + "*_*");
		}
		System.out.println();
...
//		}
	...
	public void testCollection2() {
		...
		coll.add(new Person("MM", 23));
		System.out.println(coll); // [123, AA, Wed Mar 14 00:07:07 CST 2018, BB, com.cwp.java1.Person@49c2faae]
		...
		boolean b11 = coll.contains(new String("AA"));
		...
		System.out.println(coll); // [123, AA]
	...
	public void testCollection1() {
		...
		coll.addAll(coll1);
		// 查看集合元素
		System.out.println(coll);//[123, AA, Wed Mar 14 00:17:36 CST 2018, BB, 1, 2, 3]

 ...
 * @author 叔公
 */
public class _04工具类Collections {
    /*
...
//		List list1 = new ArrayList();//错误的实现方式
        ...
        System.out.println(list1);//[123, 456, 12, 78, 456]
     ...
     *	排序算法(List)：根据元素的自然顺序对指定 List 集合元素按升序排序
     *	排序算法(List，Comparator)：根据指定的 Comparator 产生的顺序对 List 集合元素进行排序
